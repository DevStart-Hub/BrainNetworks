...
Each brain network is a 100×100 connectivity matrix, just like the one we saw in the previous tutorial. The full dataset is stored as a single array with shape `[20, 100, 100]`.
